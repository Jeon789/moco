...
def print_setting(config):
    print(Stdout_Font.Blue  + 'Combined Style      :  {}'.format(config['combined_style'])              + Stdout_Font.Reset)
    print(Stdout_Font.Blue  + 'sim type            :  {}'.format(config['sim'])                         + Stdout_Font.Reset)
    print(Stdout_Font.Blue  + 'Degradation Types   :  {}'.format(', '.join(config['degradation_type'])) + Stdout_Font.Reset)
    print('Epoch : {} / loss_fn: {} / mlcl_loss : {}'.format(config['epochs'], config['loss_fn'], config['mlcl_loss']))
